...
folder1 = 'C:\Users\Kyle\Documents\GitHub\Matlab Visuals\figure files';

% main folder
folder2 = 'C:\Users\Kyle\Documents\GitHub\Matlab Visuals';
...
cd(folder3)
imagelabel2 = strcat(imagelabel,'-MRI-Render','.fig'); %Change to jpg if desired
title(imagelabel)
saveas(gcf, imagelabel2, 'fig') %Change to jpg if desired
